...
% also ctan.org/pkg/tex-gyre or tex-gyre-schola
...
\newfontfamily\scotusfamily[Scale=1.18]{texgyreschola-bold.otf}
\newfontfamily\noticefamily[Scale=0.72]{texgyreschola-regular.otf}
...
\pagestyle{fancy}
\fancyhead{}
\fancyhead[LE,RO]{\thepage \vspace{4ex}}
\fancyhead[CO]{\small Cite as: 123 U.S. 123 (1234) \\ \bigskip Opinion of the Court}
\fancyhead[CE]{\small BATSAKIS \emph{v.} DEMOTSIS \\ \bigskip Opinion of the Court}
\fancyfoot{}
\renewcommand{\headrulewidth}{0pt}

\setlength{\headheight}{38pt}
\setlength{\headsep}{5pt}
% Here are various setlengths you may want in future.
%\setlength{\parskip}{11pt plus 1pt minus 1pt}
%\setlength{\parindent}{0pt}

\begin{document}

\parbox{3.46in}{\noticefamily NOTICE: This opinion is subject
  to formal revision before publication in the preliminary print of
  the United States Reports. Readers are requested to notify the
